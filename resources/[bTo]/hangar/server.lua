...
RegisterServerEvent('ply_hangares:CheckForSpawnVeh')
RegisterServerEvent('ply_hangares:CheckForVeh')
RegisterServerEvent('ply_hangares:SetVehOut')
RegisterServerEvent('ply_hangares:SetVehIn')
RegisterServerEvent('ply_hangares:PutVehInGarages')
RegisterServerEvent('ply_hangares:CheckHangarForVeh')
RegisterServerEvent('ply_hangares:CheckForSelVeh')
RegisterServerEvent('ply_hangares:SelVeh')
...
AddEventHandler('ply_hangares:CheckForSpawnVeh', function(veh_id)
  TriggerEvent('es:getPlayerFromId', source, function(user)
    ...
    TriggerClientEvent('ply_hangares:SpawnVehicle', source, vehicle, plate, state, primarycolor, secondarycolor, pearlescentcolor, wheelcolor)
  end)
end)

AddEventHandler('ply_hangares:CheckForVeh', function()
  TriggerEvent('es:getPlayerFromId', source, function(user)
    local state = "Sortit"
    local player = user.identifier
    ...
    TriggerClientEvent('ply_hangares:StoreVehicle', source, vehicle, plate)
  end)
end)

AddEventHandler('ply_hangares:SetVehOut', function(vehicle, plate)
  TriggerEvent('es:getPlayerFromId', source, function(user)
    local player = user.identifier
    local vehicle = vehicle
    local state = "Sortit"
...
AddEventHandler('ply_hangares:SetVehIn', function(plate)
  TriggerEvent('es:getPlayerFromId', source, function(user)
    local player = user.identifier
    local plate = plate
    local state = "Rentré"
...
AddEventHandler('ply_hangares:PutVehInGarages', function(vehicle)
  TriggerEvent('es:getPlayerFromId', source, function(user)
...
AddEventHandler('ply_hangares:CheckHangarForVeh', function()
  vehicles = {}
  TriggerEvent('es:getPlayerFromId', source, function(user)
    local player = user.identifier  
    local executed_query = MySQL:executeQuery("SELECT * FROM user_vehicle WHERE identifier = '@username'",{['@username'] = player})
    ...
    TriggerClientEvent('ply_hangares:getVehicles', source, vehicles)
end)

AddEventHandler('ply_hangares:CheckForSelVeh', function()
  TriggerEvent('es:getPlayerFromId', source, function(user)
    local state = "Sortit"
    local player = user.identifier
    local executed_query = MySQL:executeQuery("SELECT * FROM user_vehicle WHERE identifier = '@username' AND vehicle_state ='@state'",{['@username'] = player, ['@vehicle'] = vehicle, ['@state'] = state})
    ...
    TriggerClientEvent('ply_hangares:SelVehicle', source, vehicle, plate)
  end)
end)


AddEventHandler('ply_hangares:SelVeh', function(plate)
  TriggerEvent('es:getPlayerFromId', source, function(user)
    local player = user.identifier
    local plate = plate
